                    ...
                    <HeadlessTabPanels class="flex-1">
                        ...
                        <HeadlessTabPanel>
                            <AwesomeCard class="mb-6">
                                <AwesomeCardContent>
                                    ...
                                    />
                                    <p class="mb-2">
                                        type your github username and click the
                                        button to validate.
                                    </p>
                                    <div class="flex">
                        ...
                        <HeadlessTabPanel>
                            ...
                            >
                                ...
                                <AwesomeCardFooter class="justify-between">
                                    <p>
                                        if enable we will secure your comments
                                        from spam
                                    </p>
                                </AwesomeCardFooter>
                            </AwesomeCard>
                        ...
                        <HeadlessTabPanel>
                            <AwesomeCard class="mb-6">
                                <AwesomeCardContent>
                                    ...
                                    />
                                    <p class="mb-2">
                                        you can enable advanced settings to
                                        change the settings
                                    </p>
                                    <div class="flex">
                                        <AwesomeFormSwitch
                                            v-model="enableAdvancedSetting"
                                        >
                                            <span class="capitalize">{{
                            ...
                            >
                                <AwesomeCardContent>
                                    ...
                                    />
                                    <p class="mb-2">
                                        if no index file is present within a
                                        directory, the directory contents will
                                        be displayed.
                                    </p>
                                    <div class="flex">
                                        <AwesomeFormSwitch
